...
interface MultiDayTemperatureChartProps {
  data: DailyData[];
  title: string;
  theme: 'dark' | 'light';
}
...
const MultiDayTemperatureChart: React.FC<MultiDayTemperatureChartProps> = ({ data, title, theme }) => {
