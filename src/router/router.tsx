    ...
    <ThresholdProvider>
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/dashboard/invernadero_1"
            element={<Sidebar Dashboard={DashboardInvernadero1} />}
          />
          <Route
            path="/dashboard/comparation_invernadero_1"
            element={<Sidebar Dashboard={ComparationValuesInv1} />}
          />
          <Route
            path="/dashboard/invernadero_2"
            element={<Sidebar Dashboard={DashboardInvernadero2} />}
          />
          <Route
            path="/dashboard/comparation_invernadero_2"
            element={<Sidebar Dashboard={ComparationValuesInv2} />}
          />
          <Route
            path="/dashboard/invernadero_3"
            element={<Sidebar Dashboard={DashboardInvernadero3} />}
          />
          <Route
            path="/dashboard/comparation_invernadero_3"
            element={<Sidebar Dashboard={ComparationValuesInv3} />}
          />
          <Route
            path="/dashboard/settings"
            element={<Sidebar Dashboard={Settings} />}
          />
        </Routes>
      </Router>
    </ThresholdProvider>
